...
class CRCNNEncoder(BaseEncoder):
    ...
    def __init__(self, 
        ...
        """
        # Hyperparameters
        super(CRCNNEncoder, self).__init__(token2id, max_length, hidden_size, word_size, position_size, blank_padding, word2vec, mask_entity=mask_entity)
