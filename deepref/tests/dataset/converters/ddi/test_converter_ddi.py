from deepref.dataset.converters.converter_ddi import ConverterDDI
...
def test_should_return_preprocessed_files_for_ddi_with_stanza():
    subprocess.call(['python', 'deepref/dataset/converters/converter_ddi.py', '--nlp_tool', 'stanza', '--nlp_mode', 'scientific'])
...
def test_should_return_preprocessed_files_for_ddi_with_spacy():
    subprocess.call(['python', 'deepref/dataset/converters/converter_ddi.py', '--nlp_tool', 'spacy', '--nlp_mode', 'scientific'])
    assert os.path.exists("benchmark/ddi/original/ddi_test_original.txt")
    assert os.path.exists("benchmark/ddi/original/ddi_test_original.txt")
    assert os.path.exists("benchmark/ddi/original/ddi_test_original.txt")
    os.remove("benchmark/ddi/original/ddi_train_original.txt")
