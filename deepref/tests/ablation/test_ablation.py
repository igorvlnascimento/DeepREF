from deepref.config import TYPE_EMBEDDINGS
...
# @mock.patch('deepref.framework.train.Training.__init__')
# @mock.patch('deepref.framework.train.Training.train')
...
#     assert only_sdp
#     os.remove('deepref/ablation/semeval2010_bert_entity_ablation_studies.csv')
