...
class ConverterSemEval20181_1(ConverterSemEval2018):
    def __init__(self, nlp_tool, nlp_model) -> None:
        super().__init__(dataset_name="semeval20181-1", entity_name="ENTITY", nlp_tool=nlp_tool, nlp_model=nlp_model)
...
if __name__ == '__main__':
    ...
    converter = ConverterSemEval20181_1(args.nlp_tool, args.nlp_model)
