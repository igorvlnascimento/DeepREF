    ...
    def load_embedding(self):
        ...
        if 'elmo' == self.embedding_name:
            ...
            if not os.path.exists(os.path.join(self.path_word, 'fasttext_crawl.1M.300d_word2id.json')):
                ...
                word2id = json.load(open(os.path.join(self.path_word, 'fasttext_crawl.1M.300d_word2id.json')))
                word2vec = np.load(os.path.join(self.path_word, 'fasttext_crawl.1M.300d._mat.npy'))
