...
sys.path.insert(0, "/home/igor/code/mestrado/REDN/opennre/framework")
sys.path.insert(0, "/home/igor/code/mestrado/REDN/opennre/dataset")

import torch
from ..dataset.utils import is_normal, is_multi_label, is_over_lapping
from .data_loader import SentenceREDataset
import random
import pandas as pd
