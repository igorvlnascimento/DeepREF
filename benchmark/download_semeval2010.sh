...
python deepref/dataset/converters/semeval2010_converter.py --nlp_tool $NLP_TOOL --nlp_model $NLP_MODEL --train_path benchmark/raw_semeval2010/TRAIN_FILE.TXT --test_path benchmark/raw_semeval2010/TEST_FILE_FULL.TXT
