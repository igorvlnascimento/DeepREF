...
python deepref/dataset/converters/semeval2018_converter.py --dataset semeval20181-1 --train_path benchmark/raw_semeval20181-1/Train/ --test_path benchmark/raw_semeval20181-1/Test/ --nlp_tool $NLP_TOOL --nlp_model $NLP_MODEL
