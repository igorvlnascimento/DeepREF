...
parser.add_argument('--pretrain_path', default='distilbert-base-uncased', 
...
if args.pooler == 'entity':
    sentence_encoder = opennre.encoder.DistilBertEntityEncoder(
        max_length=args.max_length, 
        pretrain_path=args.pretrain_path,
        mask_entity=args.mask_entity
    )
elif args.pooler == 'cls':
    sentence_encoder = opennre.encoder.DistilBertEncoder(
        max_length=args.max_length, 
        pretrain_path=args.pretrain_path,
        mask_entity=args.mask_entity
    )
...
framework.get_confusion_matrix(ground_truth, pred, 'confusion_matrix_distilbert', only_test=args.only_test)
