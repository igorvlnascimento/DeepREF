...
if args.pooler == 'entity':
    sentence_encoder = opennre.encoder.BERTCNNEntityEncoder(
...
framework.get_confusion_matrix(ground_truth, pred, 'confusion_matrix_bert_cnn_entity', only_test=args.only_test)
